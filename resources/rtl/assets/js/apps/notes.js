$(document).ready(function() {
    ...
    $("#btn-n-add").on('click', function(event) {
        ...
        let $html = '<div class="note-item all-notes">' +
...
let getNoteTitleInput = document.getElementById('n-title');

getNoteTitleInput.addEventListener('input', function() {

    let getNoteTitleInputValue = this.value;
...
let getNoteDescriptionInput = document.getElementById('n-description');

getNoteDescriptionInput.addEventListener('input', function() {

  let getNoteDescriptionInputValue = this.value;
