    ...
    <div class="widget-heading">
        ...
        <div class="task-action">
            ...
            <div class="btn-group c-custom-dropdown dropend" role="group">
                <button id="btndefault" type="button" class="dropdown-toggle show" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                </button>
                
                <div class="dropdown-menu dropdown-menu-end show" aria-labelledby="btndefault" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(31px, 0px);" data-popper-placement="right-start">
                    <a class="dropdown-item" href="javascript:void(0);">View All</a>
                    <a class="dropdown-item" href="javascript:void(0);">Mark as Read</a>
                </div>
            </div>
